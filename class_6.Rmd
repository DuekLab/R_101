...
df |> select(what_is_your_height_in_cm, what_is_your_weight_in_kg, what_is_you_gender) |>   tbl_summary(by = what_is_you_gender,
    label = list(what_is_your_height_in_cm = "Height (cm)", what_is_your_weight_in_kg = "Weight (Kg)")) |> add_p() |> bold_labels() |> add_overall()
```
...
ggplot(df, aes(x=what_is_you_gender, y=what_is_your_height_in_cm, color = what_is_you_gender)) + geom_boxplot() + theme_minimal()
...
## Using it
```{r}
ggplot(df, aes(x=what_is_your_weight_in_kg, y=what_is_your_height_in_cm, color = what_is_you_gender)) + 
...
```{r}
ggplot(df, aes(x=what_is_your_weight_in_kg, y=what_is_your_height_in_cm, color = what_is_you_gender)) + 
  geom_point() + geom_smooth(method='lm', alpha=.2) + theme_minimal()
```
